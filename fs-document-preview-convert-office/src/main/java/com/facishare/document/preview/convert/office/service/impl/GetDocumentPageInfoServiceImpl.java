 ...
 */
@Service
public class GetDocumentPageInfoServiceImpl implements GetDocumentPageInfoService {
  ...
  public PageInfo getWordPageInfo(byte[] data, String filePath) {
    GetPageInfo getPageInfo = new GetPageInfo();
  ...
  public PageInfo getExcelPageInfo(byte[] data, String filePath) {
    GetPageInfo getPageInfo = new GetPageInfo();
    PageInfo pageInfo = new PageInfo();
    try {
      if (!ParameterCalibration.checkIsEncrypt(data, filePath)) {
  ...
  public PageInfo getPptPageInfo(byte[] data, String filePath) {
    GetPageInfo getPageInfo = new GetPageInfo();
    PageInfo pageInfo = new PageInfo();
    try {
      if (!ParameterCalibration.checkIsEncrypt(data, filePath)) {
  ...
  public PageInfo getPdfPageInfo(byte[] data, String filePath) {
    GetPageInfo getPageInfo = new GetPageInfo();
    PageInfo pageInfo = new PageInfo();
    try {
      if (!ParameterCalibration.checkIsEncrypt(data, filePath)) {
