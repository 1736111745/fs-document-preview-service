...
public class DocumentPageInfoServiceImpl implements DocumentPageInfoService {
  ...
  public PageInfo getPageInfo(InputStream file, FileTypeEnum fileTypeEnum) {
    switch (fileTypeEnum) {
      case DOC:
      case DOCX:
  ...
  @Override
  public PageInfo getWordPageCount(InputStream file) {
  ...
  @Override
  public PageInfo getPptPageCount(InputStream file) {
  ...
  @Override
  public PageInfo getExcelPageCount(InputStream file) {
  ...
  @Override
  public PageInfo getPdfPageCount(InputStream file) {
    try (com.aspose.pdf.Document pdf = InitializeAsposePdfUtil.getPdf(file)) {
