...
public enum ErrorInfoEnum {
  ...
  PAGE_NUMBER_PARAMETER_ZERO("400", "文件损坏了，页码为0"),
  ...
  EXCEL_ENCRYPTION_ERROR("400", "Excel 文档对象实例化失败，可能的错误是文件加密了"),
  PPT_ENCRYPTION_ERROR("400", "PPT 文档对象实例化失败，可能的错误是文件加密了"),
  PDF_ENCRYPTION_ERROR("400", "PDF 文档对象实例化失败，可能的错误是文件加密了"),
  WORD_INSTANTIATION_ERROR("400", "Word 文档对象实例化失败，可能的错误文件损坏了"),
  EXCEL_INSTANTIATION_ERROR("400", "Excel 文档对象实例化失败，可能的错误是文件损坏了"),
  PPT_INSTANTIATION_ERROR("400", "PPT 文档对象实例化失败，可能的错误是文件损坏了"),
  PDF_INSTANTIATION_ERROR("400", "PDF 文档对象实例化失败，可能的错误是文件损坏了"),
  ABNORMAL_FILE_SIGNATURE("500", "文件签名文件验证异常，可能的错误是流未正常的打开"),
