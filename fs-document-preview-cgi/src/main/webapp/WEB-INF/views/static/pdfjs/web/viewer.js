        ...
        var TextLayerBuilder = (function TextLayerBuilderClosure() {
            ...
            TextLayerBuilder.prototype = {
                _finishRendering: function TextLayerBuilder_finishRendering() {
                    ...
                    var loadUrl=this.textLayerDiv.baseURI;
                    var fileUrl=getQueryStringByNameWithUrl(loadUrl,"file");
                    fileUrl=decodeURIComponent(fileUrl);
                    var pageIndex=getQueryStringByNameWithUrl(fileUrl,"page");
                    var iframeId='frame'+pageIndex;
                    var divPageId='divPage'+pageIndex;
                    window.parent.$('#'+iframeId).height(this.viewport.height+20);
                    window.parent.$('#'+divPageId).removeClass("lazy");
                    window.parent.$('#'+divPageId).removeClass("border");
