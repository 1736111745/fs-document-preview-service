...
public enum ErrorInfoEnum {
  ...
  FILE_PARAMETER_ERROR("400", "没有获取到正确的文件，可能的错误是网络波动导致文件错误的传递"), PAGE_NUMBER_PARAMETER_ZERO("400", "文件损坏了，页码为0"), PAGE_NUMBER_PARAMETER_ERROR("400",
    ...
    "Word 文件转换图片失败 可能的错误是保存的目标路径并不存在"), UNABLE_CREATE_FOLDER("500", "不能在目标路径创建文件夹 可能的错误是目标路径并不存在"),
