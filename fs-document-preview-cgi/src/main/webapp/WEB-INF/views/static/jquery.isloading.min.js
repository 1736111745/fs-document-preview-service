 ...
 */(function (e, t, n, r) {
        ...
        init: function () {
            ...
            switch (this.options.position) {
                case"inside":
                    ...
                    break;
                case"overlay":
                    if (e(this.element).is("body"))e("body").prepend('<div class="isloading-overlay" style="position:fixed; left:0; top:0; z-index: 10000; background: rgba(0,0,0,0.5); width: 100%; height: 100%" />'); else {
                        var n = e(this.element).position();
                        e(this.element).prepend('<div class="isloading-overlay" style="position:absolute; top: ' + n.top + "px; left: " + n.left + "px; z-index: 10000; background: rgba(0,0,0,0.5); width: " + e(this.element).outerWidth() + "px; height: " + e(this.element).outerHeight() + 'px;" />')
                    }
            ...
            if ("overlay" === this.options.position)e(".isloading-overlay").remove(); else {
    ...
    e.fn[i] = function (t) {
        return this.each(function () {
            if (!e.data(this, "plugin_" + i))e.data(this, "plugin_" + i, new o(this, t)); else {
