...
public enum ErrorInfoEnum {
  FILE_TYPES_DO_NOT_MATCH("400", "文件类型不是受支持的类型"), FILE_PATH_EMPTY("400", "文件路径是空的"), EMPTY_FILE("400", "文件是空的"), FILE_PARAMETER_NULL("400",
    "文件参数是空的"), FILE_PARAMETER_ERROR("400", "没有获取到正确的文件，可能的错误是网络波动导致文件错误的传递"),
  ...
  WORD_ENCRYPTION_ERROR("400", "Word 文档对象实例化失败，文件加密了"), EXCEL_ENCRYPTION_ERROR("400",
    ...
    "Excel 文档对象实例化失败，可能的错误是文件损坏了"),
  PPT_INSTANTIATION_ERROR("400", "PPT 文档对象实例化失败，可能的错误是文件损坏了"), PDF_INSTANTIATION_ERROR("400",
    "PDF 文档对象实例化失败，可能的错误是文件损坏了"),
  ABNORMAL_FILE_SIGNATURE("500", "文件签名文件验证异常，可能的错误是流未正常的打开"),
  STREAM_CLOSING_ANOMALY("500", "流关闭异常"), EXCEL_FILE_SAVING_FAILURE(
    "500",
